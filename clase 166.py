...
def draw(keypress,a1,a2,a3,a4,a5):
    ...
    a5=d5.get()
    if keypress=="c":
        draw_Circle=canvas_1.create_oval(a1,a2,a3,a4,fill=a5)
            
        
    if keypress=="l":
        draw_Line=canvas_1.create_line(a1,a2,a3,a4,fill=a5)
        
    if keypress=="r":
        draw_Rectangule=canvas_1.create_rectangle(a1,a2,a3,a4,fill=a5)
